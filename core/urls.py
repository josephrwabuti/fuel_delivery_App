...
urlpatterns = [
    ...
    path('orders/export/', views.admin_orders_export, name='admin_orders_export'),
    path('customers/', views.admin_customers, name='admin_customers'),
    path('customers/export/', views.admin_customers_export, name='admin_customers_export'),
    path('reports/', views.admin_reports, name='admin_reports'),
    path('reports/export/', views.admin_reports_export, name='admin_reports_export'),
