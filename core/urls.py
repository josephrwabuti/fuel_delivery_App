...
urlpatterns = [
    ...
    path('admin/driver/approve/<int:driver_id>/', views.approve_driver, name='approve_driver'),
    path('admin/driver/reject/<int:driver_id>/', views.reject_driver, name='reject_driver'),
    path('admin/driver/suspend/<int:driver_id>/', views.suspend_driver, name='suspend_driver'),
